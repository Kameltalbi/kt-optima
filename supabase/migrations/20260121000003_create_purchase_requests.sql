...
CREATE TABLE IF NOT EXISTS public.demandes_achat (
    ...
    notes TEXT,
    bon_commande_id UUID REFERENCES public.purchase_orders(id) ON DELETE SET NULL, -- Lien vers le bon de commande créé
...
-- Index
CREATE INDEX idx_demandes_achat_company_id ON public.demandes_achat(company_id);
CREATE INDEX idx_demandes_achat_demandeur_id ON public.demandes_achat(demandeur_id);
CREATE INDEX idx_demandes_achat_statut ON public.demandes_achat(statut);
CREATE INDEX idx_demandes_achat_date_demande ON public.demandes_achat(date_demande);
...
-- Index
CREATE INDEX idx_demande_achat_lignes_demande_id ON public.demande_achat_lignes(demande_achat_id);
CREATE INDEX idx_demande_achat_lignes_produit_id ON public.demande_achat_lignes(produit_id);
