...
// Définition des modules avec leurs codes
const modules = [
  { 
  ...
  { 
    ...
    label: "Stock", 
    path: "/stock",
    moduleCode: 'dashboard' as ModuleCode // Stock utilise dashboard pour l'instant
  },
  { 
    icon: Wallet, 
    label: "Finance", 
...
export function Sidebar({ onClose }: SidebarProps) {
  ...
  return (
    ...
    >
      ...
      {/* Navigation - Modules filtrés par permissions */}
